jQuery ->
  $('#invoice_line_invoicing_milestone_id').change ->
    ...
    if $('#invoice_line_invoicing_milestone_id').val() != ''
      ...
      invoice_header_id = $('#invoice_line_invoice_header_id').val()
      url = '/admin/api/invoicing_milestones/uninvoiced_amount?invoicing_milestone_id=' + invoicing_milestone_id + '&invoice_header_id=' + invoice_header_id
      $.ajax  url,
